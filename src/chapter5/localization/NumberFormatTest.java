...
public class NumberFormatTest {
    ...
    public static void main( String... args ){
        ...
        try{
            ...
            System.out.println("Parsed DE price: " + parsedPrice);

            Number parsedPriceInDouble = moneyEN.parse(priceStringEN);
            System.out.println("Parsed EN price: " + parsedPriceInDouble);
        }
